  ...
  head: () => ({
    meta: [
      ...
      { title: "Expansion Soluções em Logística" },
      {
        name: "description",
        content:
          "Expansion Soluções em Logística oferece mão de obra temporária para empresas: carga e descarga, separação, embalagens, inventários e equipe disponível 24 horas.",
      },
      { name: "author", content: "Expansion Soluções em Logística" },
      { property: "og:title", content: "Expansion Soluções em Logística" },
      {
        property: "og:description",
        content:
          "Mão de obra temporária para operações logísticas: carga e descarga, separação, embalagens, inventários e equipe 24h.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Expansion Soluções em Logística" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@expansionlog" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "../public/favicon.jpg", type: "image/x-icon" },
